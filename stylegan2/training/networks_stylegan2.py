...
def G_synthesis_stylegan_revised(
    ...
    dlatent_size        = 512,          # Disentangled latent (W) dimensionality.
    num_channels        = 3,            # Number of output color channels. Modified by chenqi: 3->1 for grayscale img
...
def D_stylegan(
    ...
    num_channels        = 3,            # Number of input color channels. Overridden based on dataset. Modified by chenqi: 3->1 for grayscale img
