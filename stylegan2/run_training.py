...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics, resume_pkl=None): # modify for resume training
    ...
    train.resume_pkl = resume_pkl # modify: newly added: for resume training
...
def main():
    ...
    parser.add_argument('--resume-pkl', help="Resume from pkl file", default=None) # modify: newly added: for resume training
