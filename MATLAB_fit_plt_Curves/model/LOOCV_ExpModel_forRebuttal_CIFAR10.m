% ONLY for CIFAR10 stylegan2 (for rebuttal):

% fit curves with across dataset validation,
% for threshold = 2000:
...
%% (1) stylegan2 CIFAR10:
x1 = [17.89, 23.32, 25.73, 26.49]'; % ID
x1_norm = (x1-x_mean_common) / x_std_common;
y1 = [24.02, 17.97, 16.70, 17.58].'; % rep percent thresh 2000
xx1 = linspace(15,30,50); % for x = ID
