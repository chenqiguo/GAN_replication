% ONLY for new resolution (256x256) on FLOWER_256_xxx (for rebuttal):
...
%y1 = [24.02, 14.94, 15.63, 15.33]';  % rep percent thresh 23000
y1 = [48.13, 15.42, 11.04, 9.38]';  % final ver: rep percent thresh 18000
...
% Then plot curves:
title_list = {'stylegan2 FLOWER 256x256'};
