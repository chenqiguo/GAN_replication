% ONLY for earlier iterations on stylegan FLOWER_128_xxx (for rebuttal):
...
y1 = [20.61, 11.23, 9.67]';  % rep percent thresh 10000
...
% Then plot curves:
title_list = {'stylegan2 FLOWER 128x128 early iteration'};
