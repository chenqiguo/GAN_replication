% ONLY for new k1&k2 values (when computing ID) on FLOWER_128_xxx (for rebuttal):
...
%% (1) biggan FLOWER:
x1 = [20.23, 22.95, 25.61, 27.11, 28.43]'; % ID
