...
def prepare_inception_metrics(dataset, parallel, no_fid=False):
  ...
  def get_inception_metrics(sample, num_inception_images, num_splits=10, 
                            prints=True, use_torch=False): # my modify here: original: use_torch=True
    if prints:
    ...
    if no_fid:
      ...
      if use_torch:
        ...
        FID = numpy_calculate_frechet_distance(mu, sigma, data_mu, data_sigma) # they are already numpy array!!!
