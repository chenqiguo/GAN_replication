...
#--batch_size 32
python train.py \
--model BigGANdeep --data_root /eecf/cbcsl/data100b/wen/Data/Datasets \
--dataset CelebA_128_sub200 --shuffle  --num_workers 16 --batch_size 32 \
--device '1' \
...
--num_epochs 153000 --resume \
#--num_epochs 150000 #155000