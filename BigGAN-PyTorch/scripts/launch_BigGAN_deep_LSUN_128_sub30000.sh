#!/bin/bash
python train.py \
--model BigGANdeep --data_root /eecf/cbcsl/data100b/Chenqi/stylegan2/datasets_images \
--dataset LSUN_128_sub30000 --shuffle --num_workers 16 --batch_size 48 \
--device '1' \
